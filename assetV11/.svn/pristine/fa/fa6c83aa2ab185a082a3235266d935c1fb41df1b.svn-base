define(function(){
	...
	var DATA = {
		...
		//以下数据服务器获取更新覆盖
		vip_type : [
			{v : "0",t : "储蓄车"},{v : "1",t : "临时车"},{v : "2",t : "免费车"},
			{v : "3",t : "月租车"},{v : "7",t :" 货车"},{v : "5",t :" 黑名单"},{v : "8",t :" 地库车"},
			{v : "10",t :"亲情车"}
		],
		...
		getInState:function(v){
			return getText(DATA.car_in_state,v);
		}
